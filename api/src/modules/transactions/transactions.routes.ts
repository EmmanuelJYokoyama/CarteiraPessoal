...
import {createNewTransaction, listTransactions, getTransactionsSummary, getTransaction, updateTransactionHandler, deleteTransactionHandler, payInstallmentHandler, checkDuplicateTransactions} from './transactions.controller';

export async function transactionsRoutes(app: FastifyInstance) {
  app.post('/transactions', createNewTransaction);
  app.get('/transactions', listTransactions);
  app.get('/transactions/summary', getTransactionsSummary);
